...
public class Q9 {
    public static void main(String args[]) {
        ...
        Set<Integer> indexes = new HashSet<~>();  //1. grup oyuncunun listteki indexler,
        Set<Integer> indexes2 = new HashSet<Integer>(); //2.grup oyuncunun listteki indexleri

        List groupOfPlayers1= new ArrayList(); //1.oyuncu grubu
        List groupOfPlayers2= new ArrayList(); //2.oyuncu grubu
